...
KEY fk_aulapre_idx (ID_AULA),
  ...
  CONSTRAINT fk_alunopr_u FOREIGN KEY (ID_ALUNO) REFERENCES tb_usuario (ID_USUARIO) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT fk_matriculapr_u FOREIGN KEY (MATRICULA) REFERENCES tb_usuario (MATRICULA) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT fk_turmapr_u FOREIGN KEY (ID_TURMA) REFERENCES tb_turma (ID_TURMA) ON DELETE NO ACTION ON UPDATE NO ACTION

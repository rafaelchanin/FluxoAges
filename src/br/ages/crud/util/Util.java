...
public class Util {
	...
	public static boolean isCPF(String CPF) {
		// considera-se erro CPF's formados por uma seqncia de nmeros iguais
		...
		char dig10, dig11;
		int sm, i, r, num, peso;
		// "try" - protege o cdigo para eventuais erros de converso de tipo (int)
		try { // Calculo do 1o. Digito Verificador
			...
			if ((r == 10) || (r == 11))
				...
				dig10 = (char) (r + 48);
			// converte no respectivo caractere numrico

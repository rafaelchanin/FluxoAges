			...
			<form method="post" action="main?acao=adicionaTurma"> <!-- enctype="multipart/form-data" > -->
				...
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<input class="form-control" id="numero" name="numero" value="${param.numero}" type="text" maxlength="3" pattern="([0-9]|[0-9]|[0-9])" title="A turma é composta por três números!" required>
					</div>
				</div>

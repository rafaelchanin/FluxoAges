...
<div class="panel panel-primary panel-addUser">
	...
	<div class="panel-body">
		...
		<form method="post" action="main?acao=editaTime">
			<!-- enctype="multipart/form-data" > -->

			<input class="form-control" type="hidden" id="idTime" name="idTime"
				value="<%=time.getId()%>">
					...
					<div class="col-sm-6">
						...
						<div class='input-group date' id='dataEntrada'>
							<input type='text' class="form-control" id="ano" name="ano"
								value="<%=time.getAno()%>" required /> <span
					...
					<div class="col-sm-6">
						...
						<select class="form-control" id="semestre" name="semestre"
							...
							<option value="primeiro"
								<%=1 == time.getSemestre() ? "selected" : ""%>>Primeiro</option>
							<option value="segundo"
								<%=2 == time.getSemestre() ? "selected" : ""%>>Segundo</option>
						</select>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<select multiple="multiple" size="10" name="alunos" class="aluno">
							...
							%>
							<option
								value="<%=alunoDisponivel.getId()%> <%=alunoDisponivel.getMatricula()%>"
								selected="selected"><%=alunoDisponivel.getNome()%></option>
							<%
								}
							%>
						</select>
